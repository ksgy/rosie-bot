	...
	if (command.command === 'ORDER') {
        ...
        rosieHelper.createBasket(basketItem)
            ...
            .then(function(response){
                ...
                self.postMessage(originalMessage.channel, 'Here\'s your order, my darling :fork_and_knife: https://dine-at-sushisurpriseshoreditch.foodit.com//confirmation/' + orderId, { as_user: true });
            })
