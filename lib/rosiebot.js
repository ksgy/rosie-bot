...
RosieBot.prototype._reply = function (originalMessage) {
	...
	rosieHelper.createBasket(basketItem)
		...
		.catch(function(error){
			self.postMessage(originalMessage.channel, 'Oh dear! :scream: Chef told me _' + JSON.strigify(error.response.data) + '_, my darling... but here\'s a :cake: for you!', { as_user: true });
		});
};
