        ...
        if (command.command === 'ORDER') {
            ...
            rosieHelper.createBasket(
                ...
                .catch(function(error){
                    ...
                    self.postMessage(originalMessage.channel, 'Oh dear! :scream: Chef told me _' + JSON.stringify(error.response.data) + '_, my darling... but here\'s a ' + rosieHelper.getCompensation() + '  for you!' + rosieHelper.getHelpText(true), { as_user: true });
                });
        }
    }
};
