...
var AVAILABLE_RESTAURANTS = [
	{"restaurantId":5814808616108032,"restaurantCode":"fooditkitchen"},
	{"restaurantId":5876569541181440,"restaurantCode":"autotestgrill"}
];
...
var rosieHelper = {
    ...
    getCommandFromMessage: function(message, menuItems) {
        ...
        var restaurantCommand = /from (.+)/gi;
        var parsedRestaurant = restaurantCommand.exec(message);
        var restaurant = AVAILABLE_RESTAURANTS;
        if (parsedRestaurant) {
            restaurant = _.filter(AVAILABLE_RESTAURANTS, {restaurantCode: parsedRestaurant[0]});
		}
