...
var rosieHelper = {
	getEnv: function(originalMessage){
        ...
        return originalMessage.indexOf('PROD') > -1 ? 'prod' : 'dev';
	},
	...
	getMenu: function(originalMessage){
		return axios.get('https://api-' + rosieHelper.getEnv(originalMessage) + '.foodit.com/restaurant/' + rosieHelper.getRestaurant(originalMessage).name);
	},
